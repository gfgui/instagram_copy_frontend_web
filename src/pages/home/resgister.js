...
const Register = () => {
    return(
        <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
            <div class="pb-2 pt-4">
                <label class="block text-gray-100 text-start text-lg font-bold pb-2 px-2 mb-2 antialiased">Nome</label>
                <input type="email" name="email" id="email" placeholder="Email" class="block w-full p-4 text-lg rounded-sm bg-black"></input>
            </div>
            <div class="pb-2 pt-4">
                <input class="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Password"></input>
            </div>
